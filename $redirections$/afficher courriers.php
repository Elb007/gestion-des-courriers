...
<body>
 <div class="container bg-light pt-2">
        ...
        <div class="col-md-10 offset-md-1 ">
            ...
            <form action="action.php" method="post" id="myForm" enctype="multipart/form-data">
                ...
                <div class="form-row mt-4">
                    ...
                    <div class="col-md-12 pb-1">
                        <label>Objet de courrier : <span class="text-danger">*</span></label>
            ...
            <div> 
                <div class="col-md-3 col-lg-5 col-sm-5 mx-auto text-center pb-4">
                    <form method="POST"  action="notify.php" >
                       <button type="submit"  name="notify" id="notify" class="btn btn-outline-dark form-control rounded-pill" >
                        ...
                        Valider  Enregistrement</button> </form>
                </div>
                  <form method="POST"  action="index.php" >
                     <button class="btn btn-outline-dark form-control rounded-pill" onclick="document.getElementById('demo').innerHTML=document('location: index.php')">redirect vers Les courriers </button>
